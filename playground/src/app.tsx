				...
				<details>
					...
					<p>
						<label for="hlsl">
							...
							/>
							HLSL (default is GLSL)
						</label>
					</p>
					<p>
						<label for="format">
							Format (the output format (use 'text' if you want just the
							shader))
						</label>
						<select
							id="format"
					...
					<p>
						<label for="no-renaming-list">
							No renaming list (Comma-separated list of functions to preserve)
							<input
								type="text"
								id="no-renaming-list"
								placeholder="foo, bar"
					...
					<p>
						<label for="field-names">
							Field names (the field names for vectors: 'rgba', 'xyzw', or
							'stpq')
						</label>
						<select
							id="field-names"
					...
					<p>
						<label for="preserve-all-globals">
							...
							/>
							Preserve all globals (Do not rename functions and global
							variables)
						</label>
					</p>
					<p>
